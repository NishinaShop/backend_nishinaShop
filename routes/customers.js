...
api.delete('/eliminar_carrito', c_authenticate.decodeToken, customersController.eliminar_carrito);
api.post('/crear_venta_spei_cliente', c_authenticate.decodeToken,customersController.crear_venta_spei_cliente)
module.exports = api;